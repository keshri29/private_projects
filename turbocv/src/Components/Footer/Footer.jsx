        ...
        <Box
            ...
            <Container
                ...
                <Stack direction={'row'} spacing={6}>
                    <SocialButton label={'Github'} href={'https://github.com/keshri29'}>
                        <FaGithub />
                    </SocialButton>
                    <SocialButton label={'Snapchat'} href={'https://twitter.com/keshri029'}>
                        <FaSnapchat />
                    </SocialButton>
                    <SocialButton label={'Instagram'} href={'https://instagram.com/anurag.env'}>
                        <FaInstagram />
                    </SocialButton>
                </Stack>
            </Container>
