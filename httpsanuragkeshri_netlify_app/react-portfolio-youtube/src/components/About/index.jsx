...
const About = () => {
  ...
  useCountUp({ ref: "projectsCounter", end: 2, duration: 2 });

  return (
    <Element id="about" className="bg-primaryBackground pl-3 pr-3 pt-10 pb-12 lg:pt[40px] lg:pb[40px] ">
      <div className="container mx-auto">
        <Header title={"About Me"} />
        <div className="block sm:flex sm:gap-10">
          <div className="sm:overflow-auto  md:w-2/4 text-left">
            <img
              src={image1}
