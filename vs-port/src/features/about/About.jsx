...
// import node_js from "../../assets/icons/node_js.svg";
...
function About() {
  ...
  return (
    <HelmetProvider>
      <Helmet>
        <title>Anurag Kumar | About</title>
      </Helmet>
        ...
        <div className="flex flex-col items-center gap-x-48 xl:flex-row">
          ...
          <div>
            ...
            <h2 className="text-xl max-sm:hidden">
              Hi, I'm Anurag Kumar. A passionate MERN Developer <br />{" "}
        ...
        <div className="xl:flex xl:gap-x-24 ">
          <div className="order-1 space-y-4 text-center xl:w-1/2 ">
            ...
            <p className="text-lg font-medium leading-tight text-slate-400 xl:text-xl">
              As a Junior MERN Developer, I possess an impressive arsenal
              of skills in HTML, CSS, JavaScript, React, Tailwind, Node, Express, MongoDB, Agile(scrum). I excel in
